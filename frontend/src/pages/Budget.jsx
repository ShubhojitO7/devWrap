      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="glass-card p-5">
            <p className="text-[11px] font-sans text-white/40">Total Spent</p>
            <p className="text-2xl font-heading font-bold text-white mt-1">₹{data.stats.total}</p>
          ...
          <div className="glass-card p-5">
            <p className="text-[11px] font-sans text-white/40">Remaining</p>
            <p className="text-2xl font-heading font-bold text-emerald-400 mt-1">₹{data.stats.remaining}</p>
            <p className="text-[10px] font-sans text-white/30 mt-1">of ₹{data.stats.budget} budget</p>
          </div>
          <div className="glass-card p-5">
            <p className="text-[11px] font-sans text-white/40">Biggest Category</p>
            <p className="text-2xl font-heading font-bold text-orange-400 mt-1">Food</p>
            <p className="text-[10px] font-sans text-white/30 mt-1">₹1,840 (43%)</p>
          </div>
        </div>
                ...
                <div key={i} className="flex items-center justify-between py-2.5 border-b border-white/5">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-sans text-white/30">{e.c}</p>
                    </div>
                  </div>
